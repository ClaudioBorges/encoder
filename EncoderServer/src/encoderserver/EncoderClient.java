...
public class EncoderClient {
    ...
    public static boolean initEncoder() {
        ...
        try {
            ...
            if (EncoderServer.ENCODER_ERROR.valueOf(fromServer) == EncoderServer.ENCODER_ERROR.INIT_OK)
                state = true;
    ...
    public static boolean setCPF(String cpf) {
        ...
        try {
            ...
            fromServer = in.readLine();
            dbgMsg("Server: " + fromServer);
            EncoderServer.ENCODER_ERROR err = EncoderServer.ENCODER_ERROR.valueOf(fromServer);
            if (err == EncoderServer.ENCODER_ERROR.CPF_OK) {
                state = true;
            }
    ...
    public static boolean setPath(String path) {
        ...
        try {
            ...
            dbgMsg("Server: " + fromServer);
            EncoderServer.ENCODER_ERROR err = EncoderServer.ENCODER_ERROR.valueOf(fromServer);
            if (err == EncoderServer.ENCODER_ERROR.PATH_OK) {
                state = true;
            }
    ...
    public static boolean stopEncoder() {
        ...
        try {
            ...
            fromServer = in.readLine();            
            dbgMsg("Server: " + fromServer);
            if (EncoderServer.ENCODER_ERROR.valueOf(fromServer) == EncoderServer.ENCODER_ERROR.STOP_OK) {
                state = true;
            }            
        } catch (Exception ex) {
            Logger.getLogger(
